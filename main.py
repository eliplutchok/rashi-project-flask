...
# # Your response should be formatted like this {"answer": "your answer goes here", "relevant_passage_ids": [1, 2, 3, etc.]}. It is very important that your response be formatted correctly since I will be converting it to JSON and relying on it in my program. When referencing passages in your answer please use their book and page name instead of their ids since the user will not recognize the ids.
